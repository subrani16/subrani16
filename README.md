...
- 🐍 **Automation:** Small automation tools for data collection,  cleaning and file management. [Explore my Python scripts](https://github.com/subrani16/scripts) (WIP).
- 🌐 **Web Dev:** Track my learning progress (WIP).

---

### 📫 Connect with me:
- [LinkedIn](https://linkedin.com/in/mariag-subranic)
- [Email](mailto:subrani.g@gmail.com)

*"Turning data into high-quality training sets and code into functional solutions."*
